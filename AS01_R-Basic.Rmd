...
### your code
# (1)
vector_gender_first3_last3 <- vector_gender[c(1:3,8:10)]
...
list_journalism_sample$student_quota <-
  2*list_journalism_sample$student_quota
...
# (2)
df_first20$age[df_first20$gender=="female"]

# (3)
df_first20$released_date[df_first20$patient_id%%2==1]

# (4)
df_first20$state[df_first20$gender=="female" & df_first20$age=="Above 50"]

# (5)
df_first20$tourism_history[df_first20$age!="Above 50"]
