...
當兩個向量長度不一卻需要計算時，R會自動把較短的vector依原有的規律延長，此例中`vector_01_right`會變成`c(2,3,2,3,2)`, 因此便可與vector_01_left進行計算。
...
# method01
vector_02_b <- c(1,0,0)
vector_03 <- vector_02+vector_02_b
vector_03

# method02
vector_02_c <- c(2,1,1)
vector_04 <- vector_02*vector_02_c
vector_04
```
